...
<template>
  <section class="bg-gray-50 dark:bg-gray-900">
    ...
    >
      <a
        href="#"
        class="hover:text-green-700 transition-colors duration-300 flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white"
      >
        <img
          class="w-8 h-8 mr-2"
      ...
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <h1
            class="text-xl font-bold leading-tight tracking-tight text-green-600 dark:text-green-600 md:text-2xl"
          >
          ...
          >
            <div>
              <label
                for="email"
                class="block mb-2 text-sm font-medium text-green-600 dark:text-green-600"
                >Your email</label
              >
              <input
                type="email"
            ...
            <div>
              <label
                for="password"
                class="block mb-2 text-sm font-mediumtext-green-600 dark:text-green-600"
                >Password</label
              >
              <input
                type="password"
            ...
            <p class="text-sm font-light text-gray-500 dark:text-gray-400">
              ...
              <router-link :to="{name: 'Register'}"  class="font-medium text-green-600 hover:underline dark:text-green-500" >Sign up</router-link>
